...
export default function MenuContent({ menu }) {
  ...
  return (
    <>
      ...
      {/* ── WhatsApp FAB ── */}
      <a href="https://wa.me/60143860742?text=Assalamualaikum%2C%20saya%20ingin%20bertanya%20tentang%20menu%20DKAMPUNG."
        target="_blank" rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] rounded-full flex items-center justify-center
